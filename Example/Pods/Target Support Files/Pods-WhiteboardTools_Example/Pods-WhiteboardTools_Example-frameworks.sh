...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NETURLSchemeHandler/NETURLSchemeHandler.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SSZipArchive/SSZipArchive.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Whiteboard/Whiteboard.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WhiteboardTools/WhiteboardTools.framework"
