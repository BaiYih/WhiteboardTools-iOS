...
@property (nonatomic, strong) NETToolsView *toolsView;
...
- (void)setupToolsView
{
    self.toolsView = [[NETToolsView alloc] initWithFrame:CGRectZero];
    self.toolsView.axis = UILayoutConstraintAxisHorizontal;
    self.toolsView.distribution = UIStackViewDistributionFillProportionally;
    self.toolsView.alignment = UIStackViewAlignmentFill;
